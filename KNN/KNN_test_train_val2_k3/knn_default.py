...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default=None,
                         help="Path to the dataset JSON to run (defaults to the noise_PRESSURE dataset)")
...
#1 -Load the dataset
DATASET_PATH = Path(args.dataset) if args.dataset is not None else Path("C:\\Users\\maria\\OneDrive\\Desktop\\bolsa1\\KNN\\KNN_test_train_val2_k3\\datasets\\noise_PRESSURE_appropriate_dataset_all_runs.json")
